  ...
  return (
    <section>
      <div className="container">
        <div className="mx-auto w-full max-w-96 md:w-96">
          <div className="relative">
            <input
              ...
              value={text}
              readOnly
              className="border-stroke text-dark dark:border-dark-3 h-12 w-full rounded-lg border bg-transparent py-3 pl-5 pr-14 outline-none duration-200 selection:bg-transparent focus:border-primary dark:text-white"
            />
            <button
              onClick={copyToClipboard}
              className="text-body-color absolute right-0 top-0 flex h-12 w-14 items-center justify-center duration-200 hover:text-primary"
            >
              {copySuccess ? (
                <svg
                  width="20"
